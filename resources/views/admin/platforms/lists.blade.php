...
<body data-sidebar="dark"> @endsection
    ...
    @slot('subtitle') PlatForms @endslot
    @endcomponent
    @if(session('success'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">List of PlatForms</h4>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(in_array($platform->id, $activePlatformIds))
                                ...
                                <td>
                                    <button name="platform_id" value="{{ $platform->id }}">
                                        @if(in_array($platform->id, $activePlatformIds)) Disable @else Enable @endif
                                    </button>
                                </td>
