...
@section('title') Post Analytics @endsection
@section('css')
<!-- DataTables -->
...
<body data-sidebar="dark"> @endsection
    ...
    @slot('subtitle') Post Analytics @endslot
    @endcomponent
   <!-- Scheduled vs Published -->
    <h4>Status Summary</h4>
    <ul>
        <li>Draft: {{ $statusCounts['draft'] ?? 0 }}</li>
        <li>Scheduled: {{ $statusCounts['scheduled'] ?? 0 }}</li>
        <li>Published: {{ $statusCounts['published'] ?? 0 }}</li>
    </ul>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Posts per Platform</h4>
                    ...
                    <td>{{ $successRate[$platform->name] }}%</td>
                </tr>
            @endforeach
                        </tbody>
                    </table>
